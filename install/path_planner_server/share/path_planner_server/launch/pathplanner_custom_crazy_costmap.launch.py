...
def generate_launch_description():
    ...
    # Custom Plugin
    controller_yaml = os.path.join(get_package_share_directory('path_planner_server'), 'my_custom_crazy_costmap', 'controller.yaml')
    # Custom Plugin
    planner_yaml = os.path.join(get_package_share_directory('path_planner_server'), 'my_custom_crazy_costmap', 'planner_server.yaml')
